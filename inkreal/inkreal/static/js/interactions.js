...
function createCommentHTML(comment) {
    var avatarHtml = comment.author_avatar_url
        ? '<img src="' + comment.author_avatar_url + '" class="comment-avatar-img" alt="">'
        : '<div class="comment-avatar">' + (comment.author_avatar_letter || '?') + '</div>';
