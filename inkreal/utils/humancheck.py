...
def analyze_human_score(text):
    ...
    ai_phrases = [
        ...
        "furthermore", "moreover", "it is worth mentioning",
        "in the realm of", "navigating the", "landscape of",
        "let's dive in", "without further ado", "game-changer",
        "at the end of the day", "leverage", "synergy",
        "revolutionize", "cutting-edge", "groundbreaking",
        "seamlessly", "robust", "comprehensive guide",
        "unlock the power", "deep dive", "paradigm shift",
        "holistic approach", "in this article we will",
    ...
    contractions = len(re.findall(
        r"\b(don't|can't|won't|I'm|I've|it's|that's|there's|isn't|aren't|wasn't|weren't|couldn't|wouldn't|shouldn't|didn't|hasn't|haven't)\b",
        text, re.IGNORECASE
    ))
    if contractions >= 2:
        score += 5
